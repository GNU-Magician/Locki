...
# Form implementation generated from reading ui file 'basiccrypto.ui'
#
...
class Ui_MainWindow(object):
    ...
    def openDecrypt(self, MainWindow):
        self.obj = uibasicdecrypto2.Ui_MainWindow()
        self.window = QtWidgets.QMainWindow()
        self.obj.setupUi(self.window, 0)
        MainWindow.close()
        self.window.show()


    def ceasarCipher(self):
        text = self.plainCeasar.toPlainText()
        self.cipherCeasar.setPlainText(ceasar_cipher_enc(text.lower()))

    def puncCipher(self):
        text = self.plainPunc.toPlainText()
        self.cipherPunc.setPlainText(punc_cipher(text))

    def ceasarTab(self):
        self.stackedWidget.setCurrentIndex(1)
        self.pushButton_2.setStyleSheet("background: #0cf6ff; color: rgb(8, 16, 81); font-family: verdana; font-weight: 500;")
        self.pushButton_3.setStyleSheet("background:rgb(59, 63, 140); color: white; font-family: verdana; font-weight: 500;")

    def puncTab(self):
        self.stackedWidget.setCurrentIndex(0)
        self.pushButton_3.setStyleSheet("background: #0cf6ff; color: rgb(8, 16, 81); font-family: verdana; font-weight: 500;")
        self.pushButton_2.setStyleSheet("background:rgb(59, 63, 140); color: white; font-family: verdana; font-weight: 500;")
...
"")
        ...
        self.pushButton_2.setStyleSheet("background:rgb(59, 63, 140);\n"
"\n"
"color: white;\n"
"font-family: verdana;\n"
"font-weight: 500;")
        ...
        self.pushButton_3.setStyleSheet("background:rgb(59, 63, 140);\n"
"\n"
"color: white;\n"
"font-family: verdana;\n"
"font-weight: 500;")
...
"font-size: 12px;")
        ...
        self.puncBtn.setStyleSheet("background-color:rgb(8, 16, 81);\n"
"\n"
"color: white;\n"
"font-family: verdana;\n"
"font-weight: 500;")
        self.puncBtn.setObjectName("puncBtn")
        self.puncBtn.clicked.connect(self.puncCipher)
...
"font-weight: 500;")
        ...
        self.ceasarBtn.clicked.connect(self.ceasarCipher)
