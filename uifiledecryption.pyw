...
class Ui_MainWindow(object):
    ...
    def AEStab(self):
        ...
        self.aesBtn.setStyleSheet("background-color: rgb(8, 16, 81); color: white; font-family: verdana; font-weight: 500;")
        self.rsaBtn.setStyleSheet("background:#29B6F6; color: white; font-family: verdana; font-weight: 500;")
    
    def RSAtab(self):
        self.stackedWidget.setCurrentIndex(2)
        self.rsaBtn.setStyleSheet("background-color: rgb(8, 16, 81); color: white; font-family: verdana; font-weight: 500;")
        self.aesBtn.setStyleSheet("background:#29B6F6; color: white; font-family: verdana; font-weight: 500;")


    def rsaFindFile(self):
        self.filenames = QFileDialog.getOpenFileName(caption='Escolha o arquivo a ser restaurado', 
   directory='c:\\',filter="Qualquer arquivo (*)")
    ...
    def rsaFindKey(self):
        self.filename = QFileDialog.getOpenFileName(caption='Escolha a chave privada', 
   directory='c:\\',filter="Chave privada (*.pem)")
    ...
    def rsaDecrypt(self):
        try:
            result = misc.decryptRSA(self.filenames, self.filename) 
        ...
        if result == 2:
            label = QtWidgets.QLabel("Escolha um arquivo para ser restaurado.")
    ...
    def aesFindFile(self):
        self.aesfilenames = QFileDialog.getOpenFileName(caption='Escolha o arquivo a ser restaurado', 
   directory='c:\\',filter="Qualquer arquivo (*)")
        self.aesfilenames = self.aesfilenames[0].replace("/", "\\")
        self.fileNameLabel.setText(os.path.basename(self.aesfilenames))

    def aesDecrypt(self):
        try:
            password = self.passwordText.toPlainText()
            result = misc.file_dec(self.aesfilenames, password)
        except AttributeError:
        	result = 2
    ...
    def setupUi(self, MainWindow, number):
        ...
        self.pushButton.setStyleSheet("background:#29B6F6;color: white;\n"
"font-family: verdana;\n"
"font-weight: 500;")
        ...
        self.rsaBtn.setStyleSheet("background:#29B6F6;color: white;\n"
"font-family: verdana;\n"
"font-weight: 500;")
        self.rsaBtn.setObjectName("rsaBtn")
        self.rsaBtn.clicked.connect(self.RSAtab)

        self.aesBtn = QtWidgets.QPushButton(self.widget)
        self.aesBtn.setGeometry(QtCore.QRect(40, 230, 131, 41))
        self.aesBtn.setStyleSheet("background:#29B6F6;color: white;\n"
"font-family: verdana;\n"
"font-weight: 500;")
        self.aesBtn.setObjectName("aesBtn")
        self.aesBtn.clicked.connect(self.AEStab)
...
"font-size: 12px;")
        ...
        self.decFileSearchBtn.setStyleSheet("background-color:#0091EA;color: white;\n"
"font-family: verdana;\n"
"font-weight: 500;")
        self.decFileSearchBtn.setObjectName("decFileSearchBtn")
        self.decFileSearchBtn.clicked.connect(self.aesFindFile)
...
"font-size: 12px;")
        ...
        self.label_6.setGeometry(QtCore.QRect(130, 90, 31, 21))
...
"font-size: 12px;")
        ...
        self.decSendBtn.setStyleSheet("background-color:#0091EA;color: white;\n"
"font-family: verdana;\n"
"font-weight: 500;")
        self.decSendBtn.setObjectName("decSendBtn")
        self.decSendBtn.clicked.connect(self.aesDecrypt)
        ...
        self.label_13.setGeometry(QtCore.QRect(80, 160, 151, 21))
...
"font-size: 12px;")
        ...
        self.createKeyPairBtn.setStyleSheet("background-color:#0091EA;color: white;\n"
"font-family: verdana;\n"
"font-weight: 500;")
...
"font-size: 12px;")
        ...
        self.RSAsendbtn.setStyleSheet("background-color:#0091EA;color: white;\n"
"font-family: verdana;\n"
"font-weight: 500;")
        self.RSAsendbtn.setObjectName("RSAsendbtn")
        self.RSAsendbtn.clicked.connect(self.rsaDecrypt)
...
"font-size: 12px;")
        ...
        self.searchKeyBtnRSA.setStyleSheet("background-color:#0091EA;color: white;\n"
"font-family: verdana;\n"
"font-weight: 500;")
...
"font-size: 12px;")
        ...
        self.searchFileBtnRSA.setStyleSheet("background-color:#0091EA;color: white;\n"
"font-family: verdana;\n"
"font-weight: 500;")
...
"font-size: 12px;")
        ...
        self.actionPontua_o.triggered.connect(lambda: self.openBasicCrypto(MainWindow))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Escolha o arquivo que será recuperado,\n"
...
"salvar as duas"))
        ...
        self.label_14.setText(_translate("MainWindow", "Escolha abaixo a chave privada\n"
"e envie tudo"))
